...
public class BackGround_StartForeGround_WithOut_Notification_Bar extends Service {
    ...
    public void onCreate() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN_MR2) {
            ...
            Notification notification = new Notification.Builder(this)
                    ...
                    .addAction(R.drawable.smile,"Learn more",pendingIntent)
                    .getNotification();
            ...
            Intent cancelIntent = new Intent(this, CancelNoticeService.class);
