...
public class GridRecyclerViewActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRvGrid = findViewById(R.id.rb_grid);
        mRvGrid.setLayoutManager(new GridLayoutManager(GridRecyclerViewActivity.this,3));
        mRvGrid.setAdapter(new LinearRecyclerViewActivity.GridAdapter(GridRecyclerViewActivity.this, new LinearRecyclerViewActivity.GridAdapter.OnItemClickListener() {
            @Override
